							...
							<div class="row">
								...
								<div class="col-lg-4 col-12 d-flex flex-column">
									<div class="flex-grow-1 bg-danger p-30 flex-grow-1 bg-img"
										style="background-position: calc(100% + 0.5rem) bottom; background-size: auto 70%; background-image: url(../images/svg-icon/color-svg/custom-3.svg)">
...
<script src="{{asset('assets/vendor_components/d3/d3.min.js')}}"></script>
<script src="{{asset('assets/vendor_components/d3/d3_tooltip.js')}}"></script>
