		  ...
		  <div class="row">
			...
			<div class="col-12">
			  <div class="box">
				...
				<div class="box-header">
					<h4 class="box-title">Custom file input</h4>  
				</div>
				<div class="box-body">
					...
					<div class="input-group">
					  ...
					  <button class="btn btn-secondary btn-sm" type="button" id="inputGroupFileAddon04">Button</button>
					</div>
				</div>
				...
				<!-- /.box-body -->
				  ...
				  <div class="box-body">
					...
					<h5 class="my-10">With colored Button Classes</h5>
						<div class="row">
							<div class="col-sm-4">
								<select class="selectpicker mb-20 me-10" data-style="btn-primary">
							...
							<div class="col-sm-4">
								<select class="selectpicker mb-20 me-10" data-style="btn-info btn-outline-info">
									<option data-tokens="Lorem">Sed posuere metus vel maximus fringilla.</option>
									<option data-tokens="ipsum">Nam in nisl a ligula semper euismod.</option>
									<option data-tokens="dolor">Ut rhoncus diam et elit tristique venenatis.</option>
								</select>
							...
							<div class="col-sm-4">
								<select class="selectpicker mb-20 me-10" data-style="btn-warning ">
									<option data-tokens="Lorem">Sed posuere metus vel maximus fringilla.</option>
									<option data-tokens="ipsum">Nam in nisl a ligula semper euismod.</option>
									<option data-tokens="dolor">Ut rhoncus diam et elit tristique venenatis.</option>
								</select>
							...
							<div class="col-sm-4">
								<select class="selectpicker mb-20 me-10" data-style="btn-danger">
									<option data-tokens="Lorem">Sed posuere metus vel maximus fringilla.</option>
									<option data-tokens="ipsum">Nam in nisl a ligula semper euismod.</option>
									<option data-tokens="dolor">Ut rhoncus diam et elit tristique venenatis.</option>
								</select>
							...
							<div class="col-sm-4">
								<select class="selectpicker mb-20 me-10" data-style="btn-success">
									<option data-tokens="Lorem">Sed posuere metus vel maximus fringilla.</option>
									<option data-tokens="ipsum">Nam in nisl a ligula semper euismod.</option>
									<option data-tokens="dolor">Ut rhoncus diam et elit tristique venenatis.</option>
								</select>
