...
<script src="{{asset('assets/vendor_components/gridstack/lodash.js')}}"></script>
<script src="{{asset('assets/vendor_components/gridstack/gridstack.js')}}"></script>
<script src="{{asset('assets/vendor_components/gridstack/gridstack.jQueryUI.js')}}"></script>	
<script src="{{asset('js/pages/gridstackjs.js')}}"></script>
@endpush