...
@push('js')
<script src="{{asset('assets/vendor_components/bootstrap-markdown-master/js/bootstrap-markdown.js')}}"></script>
<script src="{{asset('assets/vendor_components/marked/marked.js')}}"></script>
<script src="{{asset('assets/vendor_components/to-markdown/to-markdown.js')}}"></script>
@endpush