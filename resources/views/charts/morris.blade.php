					...
					<div class="box">
						<div class="box-body">
							...
							<ul class="list-inline text-center mt-40">
								<li>
									<h5><i class="fa fa-circle me-5 text-success"></i>Data 1</h5>
								</li>
								<li>
									<h5><i class="fa fa-circle me-5 text-info"></i>Data 2</h5>
								</li>
								<li>
									<h5><i class="fa fa-circle me-5 text-warning"></i>Data 3</h5>
								</li>
							</ul>
					...
					<div class="box">
						<div class="box-body">
							...
							<ul class="list-inline text-end">
								<li>
									<h5><i class="fa fa-circle me-5 text-primary"></i>Data 1</h5>
								</li>
								<li>
									<h5><i class="fa fa-circle me-5 text-success"></i>Data 2</h5>
								</li>
								<li>
									<h5><i class="fa fa-circle me-5 text-info"></i>Data 3</h5>
								</li>
							</ul>
				...
				<div class="col-xl-4 col-12">
					<div class="box">
						<div class="box-body">
							...
							<ul class="list-inline text-end">
								<li>
									<h5><i class="fa fa-circle me-5 text-warning"></i>Data 1</h5>
								</li>
								<li>
									<h5><i class="fa fa-circle me-5 text-danger"></i>Data 2</h5>
								</li>
							</ul>
...
<script src="{{asset('js/pages/widget-morris-charts.js')}}"></script>
@endpush