			...
			<div class="row">
				<div class="col-12">					    
				  <div class="callout bg-info">
					<h4>Nots!</h4>
					<span class="badge badge-lg badge-danger text-wrap text-start">For more info please check the plugin's official <a class="m-link" href="https://c3js.org/" target="_blank">demos &amp; documentation</a></span>
				  </div>
				</div>
...
<script src="{{asset('js/pages/c3-line.js')}}"></script>
<script src="{{asset('js/pages/c3-stap-line.js')}}"></script>
<script src="{{asset('js/pages/c3-multi-xy-line.js')}}"></script>
@endpush
