				...
				<div class="box-body p-0">
				  <ul class="todo-list">
					<li>
					  ...
					  <label for="basic_checkbox_1" class="mb-0 h-15 ms-15"></label>
					  <!-- todo text -->
					...
					<li>
					  ...
					  <label for="basic_checkbox_2" class="mb-0 h-15 ms-15"></label>
					...
					<li>
					  ...
					  <label for="basic_checkbox_3" class="mb-0 h-15 ms-15"></label>
					...
					<li>
					  ...
					  <label for="basic_checkbox_4" class="mb-0 h-15 ms-15"></label>
					...
					<li>
					  ...
					  <label for="basic_checkbox_5" class="mb-0 h-15 ms-15"></label>
					...
					<li>
					  ...
					  <label for="basic_checkbox_6" class="mb-0 h-15 ms-15"></label>
					...
					<li class="p-15">
					  <div class="box p-15 mb-0 d-block bb-2 border-danger">
						 <!-- drag handle -->
						  ...
						  <label for="basic_checkbox_7" class="mb-0 h-15 ms-15"></label>
					...
					<li class="p-15">
					  <div class="box p-15 mb-0 d-block bb-2 border-warning">
						 <!-- drag handle -->
						  ...
						  <label for="basic_checkbox_8" class="mb-0 h-15 ms-15"></label>
					...
					<li class="p-15">
					  <div class="box p-15 mb-0 d-block bb-2 border-secondary">
						 <!-- drag handle -->
						  ...
						  <label for="basic_checkbox_9" class="mb-0 h-15 ms-15"></label>
				...
				<div class="box-body p-0">
				  <ul class="todo-list">
					<li>
					  ...
					  <label for="basic_checkbox_13" class="mb-0 h-15 ms-15"></label>
					  <!-- todo text -->
					  <span class="text-line">Nulla vitae purus</span>
					  <!-- Emphasis label -->
					  <small class="badge bg-danger"><i class="fa fa-clock-o"></i> 2 mins</small>
					...
					<li>
					  ...
					  <label for="basic_checkbox_14" class="mb-0 h-15 ms-15"></label>
					  <span class="text-line">Phasellus interdum</span>
					  <small class="badge bg-info"><i class="fa fa-clock-o"></i> 4 hours</small>
					  <div class="tools">
						<i class="fa fa-edit"></i>
					...
					<li>
					  ...
					  <label for="basic_checkbox_15" class="mb-0 h-15 ms-15"></label>
					  <span class="text-line">Quisque sodales</span>
					  <small class="badge bg-warning"><i class="fa fa-clock-o"></i> 1 day</small>
					  <div class="tools">
						<i class="fa fa-edit"></i>
					...
					<li>
					  ...
					  <label for="basic_checkbox_16" class="mb-0 h-15 ms-15"></label>
					  <span class="text-line">Proin nec mi porta</span>
					  <small class="badge bg-success"><i class="fa fa-clock-o"></i> 3 days</small>
					  <div class="tools">
						<i class="fa fa-edit"></i>
					...
					<li>
					  ...
					  <label for="basic_checkbox_17" class="mb-0 h-15 ms-15"></label>
					  <span class="text-line">Maecenas scelerisque</span>
					  <small class="badge bg-primary"><i class="fa fa-clock-o"></i> 1 week</small>
					  <div class="tools">
						<i class="fa fa-edit"></i>
					...
					<li>
					  ...
					  <label for="basic_checkbox_18" class="mb-0 h-15 ms-15"></label>
					  <span class="text-line">Vivamus nec orci</span>
					  <small class="badge bg-info"><i class="fa fa-clock-o"></i> 1 month</small>
					  <div class="tools">
						<i class="fa fa-edit"></i>
...
<script src="{{asset('js/pages/extra_taskboard.js')}}"></script>
@endpush