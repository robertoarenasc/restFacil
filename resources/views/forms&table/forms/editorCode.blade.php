...
<script src="{{asset('assets/vendor_plugins/ace-builds-master/src-min-noconflict/ace.js')}}" type="text/javascript" charset="utf-8">
</script>
<script src="{{asset('js/pages/form-code-editor.js')}}"></script>
@endpush