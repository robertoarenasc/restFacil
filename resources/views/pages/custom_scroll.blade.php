	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h3 class="page-title">Custom Scrolls</h3>
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
								<li class="breadcrumb-item" aria-current="page">Sample Page</li>
								<li class="breadcrumb-item active" aria-current="page">Custom Scrolls</li>
							</ol>
						</nav>
					</div>
				</div>
		...
		<section class="content">
		  <div class="row">
			<div class="col-12">
			  ...
			  <div class="box">
				<div class="box-header with-border">
				  <h4 class="box-title">Only Content Scroll</h4>
				</div>
				<div class="box-body">
					<div class="row">
						<div class="col-md-5"><img src="../images/gallery/thumb/1.jpg" class="img-fluid" alt="" /></div>
						<div class="col-md-7">
							<div id="slimtest1">
			...
			<div class="col-12">      
			  ...
			  <div class="box">
				<div class="box-header with-border">
				  <h4 class="box-title">Both Scroll</h4>
				</div>
				<div class="box-body">
					<div id="slimtest2">
						<div class="row">
							<div class="col-md-5"><img src="../images/gallery/thumb/2.jpg" class="img-responsive" alt="" /></div>
							<div class="col-md-7">
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam rhoncus, felis interdum condimentum consectetur, nisl libero elementum eros, vehicula congue lacus eros non diam. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</p>
								<p>Vivamus mauris lorem, lacinia id tempus non, imperdiet et leo. Cras sit amet erat sit amet lacus egestas placerat. </p>
								<p>Aenean ultricies ultrices mauris ac congue. In vel tortor vel velit tristique tempus ac id nisi. Proin quis lorem velit. Nunc dui dui, blandit a ullamcorper vitae, congue fringilla lectus. Aliquam ultricies malesuada feugiat. Vestibulum placerat turpis et eros lobortis vel semper sapien pulvinar.</p>
			...
			<div class="col-12">      
			  ...
			  <div class="box">
				<div class="box-header with-border">
				  <h4 class="box-title">Scroll on Left</h4>
				</div>
				<div class="box-body">
					<div id="slimtest3">
						<div class="row">
							...
							<div class="col-md-5"><img src="../images/gallery/thumb/3.jpg" class="img-responsive" alt="" /></div>
						</div>
					</div>
				</div>
				<!-- /.box-body -->
			...
			<div class="col-12">      
			  ...
			  <div class="box">
				<div class="box-header with-border">
				  <h4 class="box-title">Custome Scroll Color</h4>
				</div>
				<div class="box-body">
					<div id="slimtest4">
						<div class="row">
							<div class="col-md-5"><img src="../images/gallery/thumb/4.jpg" class="img-responsive" alt="" /></div>
							<div class="col-md-7">
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam rhoncus, felis interdum condimentum consectetur, nisl libero elementum eros, vehicula congue lacus eros non diam. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</p>
								<p>Vivamus mauris lorem, lacinia id tempus non, imperdiet et leo. Cras sit amet erat sit amet lacus egestas placerat.</p>
								<p>Aenean ultricies ultrices mauris ac congue. In vel tortor vel velit tristique tempus ac id nisi. Proin quis lorem velit. Nunc dui dui, blandit a ullamcorper vitae, congue fringilla lectus. Aliquam ultricies malesuada feugiat. Vestibulum placerat turpis et eros lobortis vel semper sapien pulvinar.</p>
...
@push('js')
<script src="{{asset('js/pages/custom-scroll.js')}}"></script>
@endpush