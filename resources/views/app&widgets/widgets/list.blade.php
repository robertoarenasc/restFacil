	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h3 class="page-title">List widgets</h3>
		  ...
		  <div class="row">
			  ...
			  <div class="col-12 col-xl-4">
				<div class="box bg-primary-light">
					<div class="box-header with-border">
						<h4 class="box-title text-primary">People</h4>
						<ul class="box-controls pull-right">
						  <li class="dropdown">
					...
					<div class="box-body">
						<div class="d-flex align-items-center mb-30">
							...
							<div class="d-flex flex-column fw-500">
								...
								<span class="text-mute">Project Manager</span>
							</div>
						</div>
						<div class="d-flex align-items-center mb-30">
							<div class="me-15">
							...
							<div class="d-flex flex-column fw-500">
								...
								<span class="text-mute">Art Director</span>
							</div>
						</div>
						<div class="d-flex align-items-center mb-30">
							<div class="me-15">
							...
							<div class="d-flex flex-column fw-500">
								...
								<span class="text-mute">Lead Developer</span>
							</div>
						</div>
						<div class="d-flex align-items-center mb-30">
							<div class="me-15">
							...
							<div class="d-flex flex-column fw-500">
								...
								<span class="text-mute">DevOps</span>
							</div>
						</div>
						<div class="d-flex align-items-center mb-25">
							...
							<div class="d-flex flex-column fw-500">
								...
								<span class="text-mute">QA Managers</span>
							</div>
						</div>
					</div>
				</div>
			  ...
			  <div class="col-12 col-xl-4">
				<div class="box">
					<div class="box-header with-border">
						<h4 class="box-title text-primary">Authors</h4>
			  ...
			  <div class="col-12 col-xl-4">
				<div class="box bg-success-light">
					<div class="box-header with-border">
						<h4 class="box-title text-success">Todo</h4>
						<ul class="box-controls pull-right d-md-flex d-none">
						  <li class="dropdown">
							<button class="btn btn-success dropdown-toggle px-10 " data-bs-toggle="dropdown" href="#">Create</button>
							<div class="dropdown-menu dropdown-menu-end">
							  <a class="dropdown-item" href="#"><i class="ti-import"></i> Import</a>
							  <a class="dropdown-item" href="#"><i class="ti-export"></i> Export</a>
							  <a class="dropdown-item" href="#"><i class="ti-printer"></i> Print</a>
					...
					<div class="box-body">
					  <div class="media-list media-list-divided">
						...
						<div class="media media-single px-0">
						  ...
						  <span class="title fw-500 fs-16">Documentation</span>
						  <a class="fs-18 text-gray hover-info" href="#"><i class="fa fa-download"></i></a>
						</div>
						...
						<div class="media media-single px-0">
						  ...
						  <span class="title fw-500 fs-16">Download Excel version</span>
						  <a class="fs-18 text-gray hover-info" href="#"><i class="fa fa-download"></i></a>
						</div>
						...
						<div class="media media-single px-0">
						  ...
						  <span class="title fw-500 fs-16">Download Ziped version</span>
						  <a class="fs-18 text-gray hover-info" href="#"><i class="fa fa-download"></i></a>
						</div>
						...
						<div class="media media-single px-0">
						  ...
						  <span class="title fw-500 fs-16">Download Word version</span>
						  <a class="fs-18 text-gray hover-info" href="#"><i class="fa fa-download"></i></a>
						</div>
					  </div>
				  </div>
					  ...
					  <div class="media-list media-list-hover">
						<div class="media">
						  ...
						  <div class="media-body">
							...
							<p>Praesent tristique diam vitae est aliquet tempor sed ut erat.</p>
							  <span>Just now</span>
						  </div>
						</div>
						...
						<div class="media">
						  ...
						  <div class="media-body">
							...
							<p>Cras tempor diam nec metus ullamcorper, ut ultrices lacus convallis.</p>
						...
						<div class="media">
						  ...
						  <div class="media-body">
							...
							<p>In posuere tortor vel metus faucibus, eleifend blandit lorem condimentum.</p>
					  ...
					  <div class="media-list media-list-hover">
						<a class="media media-single" href="#">
						  ...
						  <div class="media-body fw-500">
							<p class="fs-16">Pellentesque rhoncus ipsum vel mauris sagittis, vulputate semper arcu consectetur.</p>
						...
						<a class="media media-single" href="#">
						  ...
						  <div class="media-body fw-500">
							<p class="fs-16">Pellentesque blandit odio id felis semper, imperdiet sagittis purus tincidunt.</p>
						...
						<a class="media media-single" href="#">
						  ...
						  <div class="media-body fw-500">
							<p class="fs-16">Aenean tincidunt tortor sit amet erat rutrum, vel condimentum ipsum gravida.</p>
						...
						<a class="media media-single" href="#">
						  ...
						  <div class="media-body fw-500">
							<p class="fs-16">Vivamus condimentum erat non turpis placerat, at volutpat metus commodo.</p>
							<span class="text-fade">55 min ago</span>
						  </div>
						</a>
			  ...
			  <div class="col-xl-4 col-12">
				<div class="box">
					...
					<div class="box-body p-0">
					  <div class="media-list media-list-hover">
						<div class="media">
						  <a class="align-self-center" href="#"><img class="avatar avatar-lg bg-success-light rounded" src="../images/avatar/avatar-16.png" alt="..."></a>
						  <div class="media-body fw-500">
							<p>
							  <a class="hover-success" href="#"><strong>Nathan</strong></a>
							  <span class="float-end text-fade">23 hours ago</span>
							</p>
							<p class="text-fade">Nullam facilisis velit eu nulla dictum volutpat.</p>
						  </div>
						</div>

						<div class="media">
						  <a class="align-self-center" href="#"><img class="avatar avatar-lg bg-success-light rounded" src="../images/avatar/avatar-15.png" alt="..."></a>
						  <div class="media-body">
							<p>
							  <a class="hover-success" href="#"><strong>Christian</strong></a>
							  <span class="float-end">3 hours ago</span>
							</p>
							<p class="text-fade">Proin iaculis eros non odio ornare efficitur.</p>
						  </div>
						</div>
						...
						<div class="media">
						  ...
						  <div class="media-body">
							<p>
							  <a class="hover-success" href="#"><strong>Dylan</strong></a>
							  <span class="float-end">Yesterday</span>
							</p>
							<p class="text-fade">Morbi quis ex eu arcu auctor sagittis.</p>
						  </div>
						</div>
			  ...
			  <div class="col-xl-4 col-12">
				<div class="box">
					...
					<div class="box-body p-0">
					  <div class="media-list media-list-hover media-list-divided">
						<div class="media">
						  <img class="avatar avatar-lg bg-danger-light rounded" src="../images/avatar/avatar-10.png" alt="...">

						  <div class="media-body fw-500">
							<p><strong>Carter</strong> <span class="float-end">33 min ago</span></p>
							<p class="text-fade">Cras tempor diam nec metus ullamcorper, ut ultrices lacus convallis.</p>
							<div class="media-block-actions">
							  ...
							  <nav class="nav g-0 gap-2 fs-16 media-hover-show">
								<a class="nav-link text-success" href="#" data-bs-toggle="tooltip" title="Approve"><i class="ion-checkmark"></i></a>
								<a class="nav-link text-danger" href="#" data-bs-toggle="tooltip" title="Delete"><i class="ion-close"></i></a>
							  </nav>
							</div>
						  </div>
						</div>
						...
						<div class="media">
						  <img class="avatar avatar-lg bg-danger-light rounded" src="../images/avatar/avatar-11.png" alt="...">

						  <div class="media-body">
							<p><strong>Nicholas</strong> <span class="float-end">11 hour ago</span></p>
							<p class="text-fade">Praesent tristique diam vitae est aliquet tempor sed ut erat.</p>
							<div class="media-block-actions">
							  <nav class="nav nav-dot-separated g-0">
								<div class="nav-item">
								  <a class="nav-link text-success" href="#"><i class="fa fa-thumbs-up"></i> (17)</a>
					...
					<div class="box-body p-0">
					  <div class="media-list media-list-hover media-list-divided">
						...
						<a class="media media-single" href="#">
						  ...
						  <div class="media-body fw-500">
							<h5>In mattis mi ut posuere consectetur.</h5>
							<small class="text-fade">By Hunter</small>
						  </div>
						</a>
						...
						<a class="media media-single" href="#">
						  ...
						  <div class="media-body fw-500">
							<h5>Proin iaculis eros non odio ornare efficitur.</h5>
							<small class="text-fade">By Jordan</small>
						  </div>
						</a>
						...
						<a class="media media-single" href="#">
						  ...
						  <div class="media-body fw-500">
							<h5>Morbi ullamcorper mauris nec gravida molestie.</h5>
							<small class="text-fade">By Owen</small>
						  </div>
						</a>
					  </div>
					</div>
				  <div class="text-center bt-1 border-light p-10">
					<a class="text-uppercase d-block fs-12" href="#">See all recent posts</a>
				  </div>
				</div>
			  </div>
			  ...
			  <div class="col-xl-4 col-12">
				<div class="box">
					...
					<div class="box-body p-0">
					  <div class="media-list media-list-hover media-list-divided inner-user-div" style="height: 345px">
						<div class="media media-single">
						  ...
						  <div class="media-right">
							<a class="btn btn-info btn-sm" href="#">Followed</a>
						  </div>
						</div>
						...
						<div class="media media-single">
						  <a href="#">
							<img class="avatar avatar-lg rounded bg-success-light" src="../images/avatar/avatar-4.png" alt="...">
						  </a>

						  <div class="media-body">
							<h6><a href="#">Xavier</a></h6>
						...
						<div class="media media-single">
						  <a href="#">
							<img class="avatar avatar-lg rounded bg-success-light" src="../images/avatar/avatar-8.png" alt="...">
						  </a>

						  <div class="media-body">
							<h6><a href="#">Grayson</a></h6>
							<small class="text-fader">SEO</small>
						  </div>
				  ...
				  <div class="text-center bt-1 border-light p-10">
					<a class="text-uppercase d-block fs-12" href="#">Invite Friends</a>
				  </div>
				</div>
			  </div>
			  ...
			  <div class="col-12 col-xl-4">
				<div class="box">
					<div class="box-header with-border">
						<h4 class="box-title">Income List</h4>
					</div>
					<div class="box-body p-0">
					  <div class="media">
						<div class="media-body">
							<div class="flexbox">
							  <div class="clearfix">
								<img class="avatar avatar-lg rounded bg-success-light" src="../images/avatar/avatar-11.png" alt="..."> <span class="ms-15 fs-18">Olivia</span>
							  </div>
					  ...
					  <div class="media">
						<div class="media-body">
							<div class="flexbox">
							  <div class="clearfix">
								<img class="avatar avatar-lg rounded bg-success-light" src="../images/avatar/avatar-12.png" alt="..."> <span class="ms-15 fs-18">William</span>
							  </div>
							  <div class="align-self-center">
					  ...
					  <div class="media">
						<div class="media-body">
							<div class="flexbox">
							  <div class="clearfix">
								<img class="avatar avatar-lg rounded bg-success-light" src="../images/avatar/avatar-10.png" alt="..."> <span class="ms-15 fs-18">Emily</span>
							  </div>
							  <div class="align-self-center">
					  ...
					  <div class="media">
						<div class="media-body">
							<div class="flexbox">
							  <div class="clearfix">
								<img class="avatar avatar-lg rounded bg-success-light" src="../images/avatar/avatar-13.png" alt="..."> <span class="ms-15 fs-18">Madison</span>
							  </div>
							  <div class="align-self-center">
