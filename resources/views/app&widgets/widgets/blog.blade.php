		...
		<section class="content">
			<div class="row">
				<div class="col-12">
					<div class="box">
						<div class="box-header no-border">
							<h4 class="box-title">Blog With Slider</h4>
						</div>
					</div>
				</div>				
				<div class="col-12">
				...
				<div class="col-12">
					<div class="box">
						<div class="box-header no-border">
							<h4 class="box-title">Blog without image With Slider</h4>
						</div>
					</div>
				</div>			
				<div class="col-12">
		  ...
		  <div class="row">
			  <div class="col-xl-5 col-12 h-p100">
				<div class="box card-inverse bg-img text-center py-80" style="background-image: url(../images/gallery/thumb/12.jpg)" data-overlay="5">
				  <div class="card-body">
					...
					<br><br>
					<a class="btn btn-primary-light" href="#">Read More</a>
				  </div>
				</div>
			  </div>
			  ...
			  <div class="col-lg-7 col-12">
				<div class="box overflow-hidden">
				  <div class="row g-0">
					...
					<div class="col-4 d-none d-md-block">
						<div class="bg-img h-p100 bar-0" style="background-image: url(../images/gallery/thumb/13.jpg)"></div>
					</div>
				  </div>
				</div>
				...
				<div class="box overflow-hidden">
				  <div class="row g-0">					  
					<div class="col-4 d-none d-md-block">
						<div class="bg-img h-p100 bar-0" style="background-image: url(../images/gallery/thumb/9.jpg)"></div>
					</div>
					<div class="col-md-8">
					  <div class="box-body">
						<h4><a href="#">Aenean venenatis arcu quis ante porttitor bibendum.</a></h4>
			  ...
			  <div class="col-md-6">
				<div class="box overflow-hidden">
				  ...
				  <div class="box-body">
					<p class="text-success text-uppercase">Quisque</p>
					<h4><a href="#">Ut ac purus ultricies, convallis dui auctor, dignissim turpis.</a></h4>
					<hr class="my-0">
			  ...
			  <div class="col-md-6">
				<div class="box overflow-hidden">
				  ...
				  <div class="box-body">
					<p class="text-primary text-uppercase">Quisque</p>
					<h4><a href="#">Ut ac purus ultricies, convallis dui auctor, dignissim turpis.</a></h4>
					<p>Vestibulum volutpat, ante sit amet dignissim imperdiet, diam diam sodales orci, in gravida lorem erat eu diam. Nulla lorem nunc, ultrices ac dignissim et, dignissim nec lacus. Praesent euismod lorem eget justo lacinia rutrum sed at mi.</p>
				  </div>
				</div>
			  ...
			  <div class="col-md-6">
				<div class="box overflow-hidden">
				  ...
				  <div class="box-body">
					<h4><a class="hover-primary" href="#">Ut ac purus ultricies, convallis dui auctor, dignissim turpis.</a></h4>
					<p>October 22, 2018</p>
			  ...
			  <div class="col-md-6">
				<div class="box overflow-hidden">
				  <div id="blog-slide1" class="carousel slide" data-bs-ride="carousel">
					<ol class="carousel-indicators">
					  <li data-bs-target="#blog-slide1" data-bs-slide-to="0" class="active"></li>
					  <li data-bs-target="#blog-slide1" data-bs-slide-to="1"></li>
					  <li data-bs-target="#blog-slide1" data-bs-slide-to="2"></li>
					</ol>
				  ...
				  <div class="box-body">
					<ul class="nav nav-dot-separated g-0 mb-1">
					  <li class="nav-item">
						<a class="nav-link" href="#">19 Oct</a>
					  </li>
					  <li class="nav-item">
						<a class="nav-link" href="#"><i class="ion-heart me-1"></i> 15</a>
					  </li>
					  <li class="nav-item">
			  ...
			  <div class="col-md-6">
				<div class="box overflow-hidden">
				  <div class="ratio ratio-16x9">
					<iframe class="w-p100" height="450" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/5203969&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"></iframe>
				  </div>
				  <div class="box-body">
					<h4><a href="#">Ut ac purus ultricies, convallis dui auctor, dignissim turpis.</a></h4>
					<p>October 22, 2022</p>
				  ...
				  <div class="box-body bt-1 btsr-0 bter-0">
					<div class="flexbox align-items-center">
					  <a class="text-primary fs-15" href="#">Continue reading...</a>
					  <ul class="flexbox">
						<li class="px-15 be-1 border-light">
						  <a class="text-muted" href="#">
						...
						<li class="px-15 be-1 border-light">
						  <a class="text-muted" href="#">
							<i class="fa fa-heart me-1"></i> 55
						  </a>
						</li>
						<li class="px-15">
						  <a class="text-muted" href="#">
							<i class="fa fa-comment me-1"></i> 96
						  </a>
						</li>
					  </ul>
					</div>
			  ...
			  <div class="col-12">			
				<div class="box">
					<div class="box-header no-border">
						<h4 class="box-title">Blog Style</h4>
					</div>
				</div>
			  </div>
			  ...
			  <div class="col-md-6">
				<div class="box">
				  <div class="box-body p-0">				  	
						<h4 class="media-heading mt-15 px-30"><a href="#">Aenean venenatis arcu quis ante porttitor bibendum.</a></h4>
			  ...
			  <div class="col-md-6">
				<div class="box overflow-hidden">
				    <div class="box-body p-0">				  	
						<h4 class="media-heading mt-15 mb-0 px-30"><a href="#">Aenean venenatis arcu quis ante porttitor bibendum.</a></h4>
						<div class="media">
						  <img class="align-self-start w-160" src="../images/gallery/thumb-sm/5.jpg" alt="Generic placeholder image">
						  <div class="media-body">
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis pharetra varius quam sit amet vulputate. Quisque mauris augue, molestie tincidunt condimentum vitae, gravida a libero.</p>
						...
						<p class="mt-0 px-30 pt-10 bg-lightest">
						  <i class="fa fa-user"></i> by <a href="#">John</a> 
						  | <i class="fa fa-calendar"></i> Sept 16th, 2018
						  | <i class="fa fa-comment"></i> <a href="#">3 Comments</a>
						  | <i class="fa fa-share"></i> <a href="#">39 Shares</a>
			  ...
			  <div class="col-md-6">
				<div class="box overflow-hidden">
				  <div class="box-body p-0">				  	
						<h4 class="media-heading mt-15 mb-0 px-30"><a href="#">Aenean venenatis arcu quis ante porttitor bibendum.</a></h4>
						<p class="mt-10 mb-0 px-30 by-1 py-10">
						  <i class="fa fa-user"></i> by <a href="#">John</a> 
						  | <i class="fa fa-calendar"></i> Sept 16th, 2018
						  | <i class="fa fa-comment"></i> <a href="#">3 Comments</a>
						  | <i class="fa fa-share"></i> <a href="#">39 Shares</a>
			  ...
			  <div class="col-md-6">
				...
				<div class="box">
				  <div class="box-body">
					...
					<div class="flexbox align-items-center mt-3">
					  <div class="btn-group">
						<a class="btn btn-xs" href="#" data-bs-toggle="tooltip" title="" data-bs-original-title="Share Facebook"><i class="fa fa-facebook"></i></a>
						<a class="btn btn-xs" href="#" data-bs-toggle="tooltip" title="" data-bs-original-title="Share Twitter"><i class="fa fa-twitter"></i></a>
						<a class="btn btn-xs" href="#" data-bs-toggle="tooltip" title="" data-bs-original-title="Share Google"><i class="fa fa-google"></i></a>
					  </div>

					  <a class="btn btn-sm btn-bold btn-outline" href="#">Read more</a>
					</div>
				  </div>
				</div>
			  </div>
