			...
			<div class="box-body">
				...
				<h5>Examples</h5>
				  <div class="gap-items gap-y">
					<button class="btn btn-rounded btn-info ms-1" id="request">Request</button>
					<button class="btn btn-rounded btn-danger ms-1" id="exit">Exit</button>
					<button class="btn btn-rounded btn-success ms-1" id="toggle">Toggle</button>
					<button class="btn btn-rounded btn-warning ms-1" id="request2">Request document</button>
					<button type="button" class="btn btn-rounded btn-box-tool fs-24" data-provide="fullscreen">
...
@push('js')
<script src="{{asset('js/pages/fullscreen.js')}}"></script>
