		  ...
		  <div class="row">
			<div class="col-lg-6 col-12">
			  ...
			  <div class="box">
				...
				<div class="box-body">
					<div id="carousel-example-generic-only-slide" class="carousel slide" data-bs-ride="carousel">                  
					  <!-- Wrapper for slides -->
		  ...
		  <div class="row">
			...
			<div class="col-lg-6 col-12">
			  ...
			  <div class="box">
				...
				<div class="box-body">
					<div id="carousel-example-generic-captions" class="carousel slide" data-bs-ride="carousel">
						<!-- Indicators -->
						  <ol class="carousel-indicators">
							<li data-bs-target="#carousel-example-generic-captions" data-bs-slide-to="0" class="active"></li>
							<li data-bs-target="#carousel-example-generic-captions" data-bs-slide-to="1"></li>
							<li data-bs-target="#carousel-example-generic-captions" data-bs-slide-to="2"></li>
						  </ol>                      
					  <!-- Wrapper for slides -->
					  <div class="carousel-inner" role="listbox">
						<div class="carousel-item active">
					  ...
					  <!-- Controls -->
					  <a class="carousel-control-prev" href="#carousel-example-generic-captions" role="button" data-bs-slide="prev">
						<span class="carousel-control-prev-icon" aria-hidden="true"></span>
						<span class="sr-only">Previous</span>
					  </a>
					  <a class="carousel-control-next" href="#carousel-example-generic-captions" role="button" data-bs-slide="next">
						<span class="carousel-control-next-icon" aria-hidden="true"></span>
						<span class="sr-only">Next</span>
					  </a>
					</div>               
