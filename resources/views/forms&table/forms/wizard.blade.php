				...
				<form action="#" class="tab-wizard wizard-circle">
					...
					<section>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label for="location3" class="form-label">Select City :</label>
					...
					<section>
						<div class="row">
							<div class="col-12">
								<div class="form-group">
									<label for="url123" class="form-label">URL :</label>
									<input type="url" class="form-control" id="url123" placeholder="http://">
								</div>
							</div>
							<div class="col-6">
								<div class="form-group">
									<label for="username123" class="form-label">Username :</label>
									<input type="text" class="form-control" id="username123">
								</div>
							</div>
							<div class="col-6">
								<div class="form-group">
									<label for="password123" class="form-label">Password :</label>
					...
					<section>
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label for="int123" class="form-label">Cardholder Name :</label>
									<input type="text" class="form-control" id="int123">
								</div>
								<div class="form-group">
									<label for="int234" class="form-label">Card Number :</label>
								...
								<div class="form-group">
									<div class="row">
										<div class="col-4">
											<label for="intType1" class="form-label">Exp Month :</label>
										...
										<div class="col-4">
											<label for="intType1" class="form-label">Exp Year :</label>
							...
							<div class="col-md-6">							
								<div class="form-group">
									<label for="addressline12" class="form-label">Address Line 1 :</label>
									<input type="text" class="form-control" id="addressline12">
								</div>

								<div class="form-group">
									<label for="addressline13" class="form-label">Address Line 1 :</label>
				...
				<form action="#" class="tab-wizard vertical wizard-circle">
					...
					<section>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label for="location2" class="form-label">Select City :</label>
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="date2" class="form-label">Date of Birth :</label>
					...
					<section>
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label for="jobTitle6" class="form-label">Job Title :</label>
									<input type="text" class="form-control" id="jobTitle6"> 
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label for="videoUrl2" class="form-label">Company Name :</label>
									<input type="text" class="form-control" id="videoUrl2">
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group">
									<label for="shortDescription2" class="form-label">Job Description :</label>
					...
					<section>
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label for="int2" class="form-label">Interview For :</label>
									<input type="text" class="form-control" id="int2"> 
								</div>
								<div class="form-group">
									<label for="intType3" class="form-label">Interview Type :</label>
									<select class="form-select" id="intType3" data-placeholder="Type to search cities" name="intType3">
								...
								<div class="form-group">
									...
									<select class="form-select" id="Location4" name="location">
										<option value="">Select City</option>
										<option value="India">India</option>
										<option value="USA">USA</option>
										<option value="Dubai">Dubai</option>
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="jobTitle5" class="form-label">Interview Date :</label>
					...
					<section>
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label for="behName2" class="form-label">Behaviour :</label>
									<input type="text" class="form-control" id="behName2">
								</div>
								<div class="form-group">
									<label for="participants5" class="form-label">Confidance</label>
									<input type="text" class="form-control" id="participants5">
								</div>
								<div class="form-group">
									<label for="participants6" class="form-label">Result</label>
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="decisions3" class="form-label">Comments</label>
									<textarea name="decisions" id="decisions3" rows="4" class="form-control"></textarea>
								</div>
								<div class="form-group">
									<label class="form-label">Rate Interviwer :</label>
									<div class="c-inputs-stacked">
				...
				<form action="#" class="validation-wizard wizard-circle">
					...
					<section>
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label for="wfirstName2" class="form-label"> First Name : <span class="danger">*</span> </label>
									<input type="text" class="form-control required" id="wfirstName2" name="firstName"> 
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label for="wlastName2" class="form-label"> Last Name : <span class="danger">*</span> </label>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label for="wlocation2" class="form-label"> Select City : <span class="danger">*</span> </label>
					...
					<section>
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label for="jobTitle3" class="form-label">Company Name :</label>
									<input type="text" class="form-control required" id="jobTitle3">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label for="webUrl3" class="form-label">Company URL :</label>
									<input type="url" class="form-control required" id="webUrl3" name="webUrl3"> 
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group">
									<label for="shortDescription3" class="form-label">Short Description :</label>
					...
					<section>
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label for="wint1" class="form-label">Interview For :</label>
									<input type="text" class="form-control required" id="wint1"> 
								</div>
								<div class="form-group">
									<label for="wintType1" class="form-label">Interview Type :</label>
								...
								<div class="form-group">
									<label for="wLocation1" class="form-label">Location :</label>
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="wjobTitle4" class="form-label">Interview Date :</label>
					...
					<section>
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label for="behName3" class="form-label">Behaviour :</label>
									<input type="text" class="form-control required" id="behName3">
								</div>
								<div class="form-group">
									<label for="participants3" class="form-label">Confidance</label>
									<input type="text" class="form-control required" id="participants3">
								</div>
								<div class="form-group">
									<label for="participants4" class="form-label">Result</label>
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="decisions2" class="form-label">Comments</label>
