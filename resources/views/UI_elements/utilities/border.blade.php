			...
			<div class="box-body">
			  <div class="row">
				<div class="col-12">					
					...
					<div class="d-flex flex-row mb-3">
					  <div class="px-25 py-15 w-200"><code>.bs-1</code></div>
					  <div class="px-25 py-15">border-left: 1px solid ...</div>
					</div>
										
					<div class="d-flex flex-row mb-3">
					  <div class="px-25 py-15 w-200"><code>.be-1</code></div>
				...
				<div class="col-12">
					<p>You can add solid borders to an element using following classes. You're able to change the border color using <a href="../content/utilities-color.html">border color utility classes</a>.</p>
					...
					<ul>
					  ...
					  <li><code>s</code>: Border left</li>
					  <li><code>e</code>: Border right</li>
				  ...
				  <div class="row">
					...
					<div class="col-lg-6 col-12">
						...
						<div class="code-preview">
						  ...
						  <div class="bs-3 border-primary h-30 p-5"><code>&lt;div class="bs-3 border-primary"&gt;&lt;/div&gt;</code></div><br>
						  <div class="be-2 border-success h-30 p-5"><code>&lt;div class="be-2 border-success"&gt;&lt;/div&gt;</code></div><br>
