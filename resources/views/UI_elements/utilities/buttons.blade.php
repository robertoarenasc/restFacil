					...
					<div class="box">
						<div class="box-body">
						  ...
						  <p class="subtitle mb-20">Using the base class <code>.btn-outline</code></p>
							<div class="clearfix">
								<button type="button" class="waves-effect waves-light btn btn-outline btn-default mb-5">Default</button>
					...
					<div class="box">
						<div class="box-body">
						  ...
						  <p class="subtitle mb-20">Using the base class <code>.btn-rounded</code></p>
							<div class="clearfix">
								<button type="button" class="waves-effect waves-light btn btn-rounded btn-default mb-5">Default</button>
					...
					<div class="box">
						<div class="box-body">
						  ...
						  <p class="subtitle mb-20">Using the base class <code>.btn-rounded</code><code>.btn-outline</code></p>
							<div class="clearfix">
								<button type="button" class="waves-effect waves-light btn btn-outline btn-rounded btn-default mb-5">Default</button>
						  ...
						  <h4 class="box-title">Split buttons</h4>
							<div class="clearfix">
								<div class="btn-group mb-5">
								  ...
								  <button type="button" class="waves-effect waves-light btn btn-default dropdown-toggle" data-bs-toggle="dropdown">
								...
								<div class="btn-group mb-5">
								  ...
								  <button type="button" class="waves-effect waves-light btn btn-primary dropdown-toggle" data-bs-toggle="dropdown">
									<span class="caret"></span>
									<span class="sr-only">Toggle Dropdown</span>
								  </button>
								  <div class="dropdown-menu">
								...
								<div class="btn-group mb-5">
								  ...
								  <button type="button" class="waves-effect waves-light btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown">
									<span class="caret"></span>
									<span class="sr-only">Toggle Dropdown</span>
								  </button>
								  <div class="dropdown-menu">
								...
								<div class="btn-group mb-5">
								  ...
								  <button type="button" class="waves-effect waves-light btn btn-success dropdown-toggle" data-bs-toggle="dropdown">
									<span class="caret"></span>
									<span class="sr-only">Toggle Dropdown</span>
								  </button>
								  <div class="dropdown-menu">
								...
								<div class="btn-group mb-5">
								  ...
								  <button type="button" class="waves-effect waves-light btn btn-danger dropdown-toggle" data-bs-toggle="dropdown">
									<span class="caret"></span>
									<span class="sr-only">Toggle Dropdown</span>
								  </button>
								  <div class="dropdown-menu">
								...
								<div class="btn-group mb-5">
								  ...
								  <button type="button" class="waves-effect waves-light btn btn-warning dropdown-toggle" data-bs-toggle="dropdown">
									<span class="caret"></span>
									<span class="sr-only">Toggle Dropdown</span>
								  </button>
								  <div class="dropdown-menu">
								...
								<div class="btn-group mb-5">
								  ...
								  <button type="button" class="waves-effect waves-light btn btn-dark dropdown-toggle" data-bs-toggle="dropdown">
									<span class="caret"></span>
									<span class="sr-only">Toggle Dropdown</span>
								  </button>
								  <div class="dropdown-menu">
								...
								<div class="btn-group mb-5">
								  ...
								  <button type="button" class="waves-effect waves-light btn btn-light dropdown-toggle" data-bs-toggle="dropdown">
									<span class="caret"></span>
									<span class="sr-only">Toggle Dropdown</span>
								  </button>
								  <div class="dropdown-menu">
					...
					<div class="box">
						<div class="box-body">
						  <h4 class="box-title">Button with Dropdown</h4>
							<div class="clearfix">
								<div class="btn-group mb-5">
								  <button type="button" class="waves-effect waves-light btn btn-default dropdown-toggle" data-bs-toggle="dropdown">Default</button>
								  <div class="dropdown-menu">
									<a class="dropdown-item" href="#">Action</a>
									<a class="dropdown-item" href="#">Another action</a>
									<a class="dropdown-item" href="#">Something else here</a>
								...
								<div class="btn-group mb-5">
								  <button type="button" class="waves-effect waves-light btn btn-primary dropdown-toggle" data-bs-toggle="dropdown">Primary</button>
								  <div class="dropdown-menu">
									<a class="dropdown-item" href="#">Action</a>
									<a class="dropdown-item" href="#">Another action</a>
									<a class="dropdown-item" href="#">Something else here</a>
								...
								<div class="btn-group mb-5">
								  <button type="button" class="waves-effect waves-light btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown">Secondary</button>
								  <div class="dropdown-menu">
									<a class="dropdown-item" href="#">Action</a>
									<a class="dropdown-item" href="#">Another action</a>
									<a class="dropdown-item" href="#">Something else here</a>
								...
								<div class="btn-group mb-5">
								  <button type="button" class="waves-effect waves-light btn btn-info dropdown-toggle" data-bs-toggle="dropdown">Info</button>
								  <div class="dropdown-menu">
									<a class="dropdown-item" href="#">Action</a>
									<a class="dropdown-item" href="#">Another action</a>
									<a class="dropdown-item" href="#">Something else here</a>
								...
								<div class="btn-group mb-5">
								  <button type="button" class="waves-effect waves-light btn btn-success dropdown-toggle" data-bs-toggle="dropdown">Success</button>
								  <div class="dropdown-menu">
									<a class="dropdown-item" href="#">Action</a>
									<a class="dropdown-item" href="#">Another action</a>
									<a class="dropdown-item" href="#">Something else here</a>
								...
								<div class="btn-group mb-5">
								  <button type="button" class="waves-effect waves-light btn btn-danger dropdown-toggle" data-bs-toggle="dropdown">Danger</button>
								  <div class="dropdown-menu">
									<a class="dropdown-item" href="#">Action</a>
									<a class="dropdown-item" href="#">Another action</a>
									<a class="dropdown-item" href="#">Something else here</a>
								...
								<div class="btn-group mb-5">
								  <button type="button" class="waves-effect waves-light btn btn-warning dropdown-toggle" data-bs-toggle="dropdown">Warning</button>
								  <div class="dropdown-menu">
									<a class="dropdown-item" href="#">Action</a>
									<a class="dropdown-item" href="#">Another action</a>
									<a class="dropdown-item" href="#">Something else here</a>
								...
								<div class="btn-group mb-5">
								  <button type="button" class="waves-effect waves-light btn btn-dark dropdown-toggle" data-bs-toggle="dropdown">Dark</button>
								  <div class="dropdown-menu">
									<a class="dropdown-item" href="#">Action</a>
									<a class="dropdown-item" href="#">Another action</a>
									<a class="dropdown-item" href="#">Something else here</a>
								...
								<div class="btn-group mb-5">
								  <button type="button" class="waves-effect waves-light btn btn-light dropdown-toggle" data-bs-toggle="dropdown">Light</button>
								  <div class="dropdown-menu">
									<a class="dropdown-item" href="#">Action</a>
									<a class="dropdown-item" href="#">Another action</a>
									<a class="dropdown-item" href="#">Something else here</a>
