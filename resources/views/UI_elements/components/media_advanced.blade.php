	  ...
	  <div class="container-full">
		...
		<section class="content">
			<div class="row">
				...
				<div class="col-md-6 col-12">
					<div class="media bg-gradient-primary mb-20 text-white">
				...
				<div class="col-md-6 col-12">
					<div class="media bg-white mb-20">
					  ...
					  <div class="media-body">
						<p><strong>Johen Doe</strong> <time class="float-end" datetime="2017-07-14 20:00">24 min ago</time></p>
					...
					<div class="media bg-white mb-20">
					  ...
					  <div class="media-body">
						...
						<ul class="list-inline mt-10">
							...
							<li class="pull-right">
								<button type="button" class="btn btn-box-tool btn-sm btn-rounded" data-bs-toggle="tooltip" title="" data-bs-original-title="Edit"><i class="fa fa-pencil"></i></button>
								<button type="button" class="btn btn-box-tool btn-sm btn-rounded" data-bs-toggle="tooltip" title="" data-bs-original-title="Delete"><i class="fa fa-trash"></i></button>
							</li>
						</ul>						
					  ...
					  <div class="media-body">
						...
						<ul class="list-inline mt-10">
							...
							<li class="pull-right media-hover-show">
								<button type="button" class="btn btn-box-tool btn-xs" data-bs-toggle="tooltip" title="" data-bs-original-title="Edit"><i class="fa fa-pencil"></i></button>
								<button type="button" class="btn btn-box-tool btn-xs" data-bs-toggle="tooltip" title="" data-bs-original-title="Delete"><i class="fa fa-trash"></i></button>
							</li>
						</ul>						
				...
				<div class="col-md-6 col-12">
					<div class="media align-items-center bg-white mb-20">
					  ...
					  <div class="box-tools pull-right">
						<button type="button" class="btn btn-box-tool btn-xs" data-bs-toggle="tooltip" title="" data-bs-original-title="Edit"><i class="fa fa-pencil"></i></button>
						<button type="button" class="btn btn-box-tool btn-xs" data-bs-toggle="tooltip" title="" data-bs-original-title="Delete"><i class="fa fa-remove"></i></button>
					  </div>
					</div>				
				</div>	
				...
				<div class="col-md-6 col-12">
					<div class="media align-items-center bg-white mb-20">
					  ...
					  <div>
						<a class="btn btn-primary btn-sm btn-rounded" href="#">Follow</a>
					  </div>
					</div>				
				</div>		
				...
				<div class="col-md-6 col-12">
					<div class="media align-items-center bg-white mb-20">
					  ...
					  <div>
						<button type="button" class="btn btn-box-tool" data-bs-toggle="tooltip" title="" data-bs-original-title="More info"><i class="fa fa-info"></i></button>
					  </div>
					</div>				
				</div>		
				...
				<div class=" col-md-6 col-12">
					<div class="media bg-white mb-20">
					  <img class="avatar" src="../images/avatar3.png" alt="...">
					  <div class="media-body">
						<p><strong>Johone Doe</strong> <time class="float-end" datetime="2017-07-14 20:00">24 min ago</time></p>
				...
				<div class="col-md-6 col-12">
					<div class="media align-items-center bg-success mb-20">
					  <img class="avatar" src="../images/avatar04.png" alt="...">
					  <div class="media-body">
						<p>New user registered</p>
				...
				<div class="col-md-6 col-12">
					<div class="media align-items-center bg-info mb-20">
					  ...
					  <div>
						<button type="button" class="btn btn-box-tool text-white btn-rounded" data-bs-toggle="tooltip" title="" data-bs-original-title="More info"><i class="fa fa-info"></i></button>
					  </div>
					</div>				
				</div>		
				...
				<div class="col-md-6 col-12">
					<div class="media bg-danger mb-20">
					  <img class="avatar" src="../images/avatar3.png" alt="...">
					  <div class="media-body">
						<p><strong>Johone Doe</strong> <time class="float-end text-white" datetime="2017-07-14 20:00">24 min ago</time></p>
					...
					<div class="media bg-white mb-20">
					  ...
					  <div class="media-body">
						<p>
						  ...
						  <time class="float-end" datetime="2017-07-14 20:00">24 min ago</time>
						</p>
				...
				<div class="col-md-6 col-12">
					<div class="media bg-info mb-20">
					  ...
					  <div class="media-body">
						<p>
						  <strong>Mail Chimp this weekend?</strong>
						  <time class="float-end text-white" datetime="2017-07-14 20:00">24 min ago</time>
						</p>
						<p class="fs-14 semibold">Johen Doe</p>
						<p class="text-white">Donec vitae laoreet neque, id convallis ante.</p>
					  </div>
				...
				<div class="col-md-6 col-12">
					<div class="media bg-white mb-20">
					  ...
					  <div class="media-body">
						<p>
						  <strong>Mail Chimp this weekend?</strong>
						  <small class="ps-1"><strong>(10)</strong></small>
						</p>
						<p>
				...
				<div class="col-md-6 col-12">
					<div class="media flex-column text-center p-40 bg-white mb-20">
					  <span class="avatar avatar-xxl bg-success opacity-60 mx-auto">
						<i class="align-sub ion ion-checkmark fs-40"></i>
					  </span>
					  <div class="mt-20">
