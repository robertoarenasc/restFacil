			...
			<div class="row">
				<div class="col-12">						    
				  <div class="callout bg-info">
					<h4>Nots!</h4>
					<span class="badge badge-lg badge-danger text-wrap text-start">For more info please check the plugin's official <a class="m-link" href="https://ecomfe.github.io/echarts-examples/public/index.html" target="_blank">demos &amp; documentation</a></span>
				  </div>
				</div>
...
<script src="{{asset('js/pages/echart-bar.js')}}"></script>
@endpush