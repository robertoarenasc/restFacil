		...
		<section class="content"> 
		  ...
		  <div class="row">     
				...
				<div class="box-body">
				  <div class="p-5">
					  ...
					  <div class="mb-30 weather-icon">
						<canvas class="me-40 text-top" id="icon1" width="90" height="90"></canvas>
		   ...
		   <div class="col-lg-6 col-12">
			 ...
			 <!-- Default box -->
			  <div class="box bg-img box-inverse" style="background-image: url(../images/gallery/thumb/9.jpg);" data-overlay="5">		
				<div class="box-body">
				  <div class="row py-30">
					<div class="col-6">
					  <div class="fs-40 grey-700">
...
<script src="{{asset('js/pages/weather.js')}}"></script>
@endpush